...
public class Cliente implements Serializable {
    ...
    @JoinTable(name = "interesses_cliente", joinColumns = {
        @JoinColumn(name = "cliente_id_cliente", referencedColumnName = "id_cliente")}, inverseJoinColumns = {
        @JoinColumn(name = "tipoproduto_id_tipo_produto", referencedColumnName = "id_tipo_produto")})
    @ManyToMany
    ...
    public String toString() {
        return "idCliente=" + idCliente + ", Nome do Cliente:"+nomeCliente+", Email do Cliente:"+emailCliente;
    }
